...
//                           BusinessProfile businessProfile, String ctaType, String ctaUrl) {
...
//    }
    ...
    public PromotionalPost(User user, String content, String imageUrl, LocalDateTime createdAt, boolean isPinned, String ctaType, String ctaUrl) {
        this.user = user;
        this.content = content;
        this.imageUrl = imageUrl;
        this.createdAt = createdAt;
